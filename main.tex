...
\begin{enumerate}
    ...
    \begin{equation}
        ...
        \end{split}
    \end{equation}
    And all other equal-time commutators vanish:
    \begin{equation}
        \begin{split}
            \comm{\hat{\phi}^{\mu}\left(t,\mathbf{x}\right)}{\hat{\phi}^{\mu}\left(t,\mathbf{y}\right)}\,&=\,0,
        \end{split}
    \end{equation}
    \begin{equation}
        \begin{split}
            \comm{\hat{\mathcal{\pi}}_{\mu}\left(t,\mathbf{x}\right)}{\hat{\mathcal{\pi}}_{\mu}\left(t,\mathbf{y}\right)}\,&=\,0.
        \end{split}
    \end{equation}
\end{enumerate}
