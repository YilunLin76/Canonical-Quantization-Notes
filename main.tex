...
\begin{enumerate}
    ...
    \begin{equation}
        \begin{split}
            \phi^{\mu}\left(\mathbf{x}\right)\,&\rightarrow\,\hat{\phi}^{\mu}\left(\mathbf{x}\right),  \\
            \mathcal{\pi}_{\mu}\left(\mathbf{x}\right)\,&\rightarrow\,\hat{\mathcal{\pi}}_{\mu}\left(\mathbf{x}\right).
        \end{split}
    \end{equation}
    These operators are taken to be Hermitian for real scalar fields:
    \begin{equation}
        \begin{split}
            \hat{\phi}^{\dagger}\left(\mathbf{x}\right)\,=\,\hat{\phi}\left(\mathbf{x}\right),\;\hat{\mathcal{\pi}}^{\dagger}\left(\mathbf{x}\right)\,=\,\hat{\pi}\left(\mathbf{x}\right).
        \end{split}
    \end{equation}
